    ...
    >
      <div className="block md:flex gap-4">
        ...
        <div className="bg-gray-50 rounded-lg p-4 w-full">
          <h4 className="text-lg text-gray-900 mb-4">Place Information</h4>
          <div className="flex flex-col gap-4 pb-4 text-sm">
            <SingleInfo title="Name" value={place.name} />
            <SingleInfo
              title="Location"
              value={`${place.location} (${place.latitude}, ${place.longitude})`}
            />
            <SingleInfo title="Description" value={place.description} />
          </div>
        </div>
      </div>
    </AdminDetailsContainer>
