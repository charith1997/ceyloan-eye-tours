...
const validTourTypes = ['secrets-of-lanka', 'wildlife', 'love-island', 'soft-adventure', 'mini-adventure', 'down-south', 'bird-watching'];

export default async function TourCategoryPage({ params }: { params: { category: string } }) {
    ...
    return (
        <section className="py-16 px-4 md:px-16">
            <div
                ...
                style={{ backgroundImage: 'url("/family tours/Secrets of Lanka Tour.jpg")' }}
            >
            ...
            <div className="py-12">
                <div className="flex flex-row bg-gradient-to-r from-red to-orange text-white px-6 py-3 rounded-md w-fit">
                    <div className='flex flex-col'>
                        ...
                        <div className='font-bold text-xl font-sans'>14 Days / 13 Nights</div>
                    </div>
                    <span className='h-auto border-l border-white mx-8' />
                    <div className='flex flex-col'>
                        <p className='font-normal text-md font-sans'>Tour Type</p>
                        <div className='font-bold text-xl font-[Work_Sans]'>Romantic Tours</div>
                    </div>
                </div>
            </div>
            ...
            <div className="px-6 md:px-16 py-10 max-w-[1400px] mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="lg:w-1/3">
                        <h3 className="text-xl font-bold text-red-500 mb-4">Tour Highlights</h3>
