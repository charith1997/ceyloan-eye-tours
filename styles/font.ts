...
export const CARD_DESCRIPTION =
  "text-white text-xl sm:text-2xl md:text-3xl tracking-wide uppercase leading-snug drop-shadow-lg transition-all duration-300";

// Additional Utility Styles
export const SECTION_TITLE =
  "text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 leading-tight tracking-tight mb-4";
